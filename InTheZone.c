...
void pre_auton()
{
	writeDebugStreamLine("being gyro init");
...
void runBasicCompAuton(string majorSide, int minorSide, int zone)
{
	...
	//drive back
	writeDebugStreamLine("Gyro Reading: %d", SensorValue[gyro]);
	turnToPos(0,minorSide);
	...
	{
		//turn partially around, drive a bit,turn fully, then drive straight
		//turnDeg(600);
	turnToPos(-1315*minorSide,minorSide);
		driveStraightAuton(300,127,1);
		//turnDeg(250);
		turnToPos(-2145*minorSide,minorSide);
